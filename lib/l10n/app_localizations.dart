...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Scan this QR to view patient details'**
  String get scanToView;

  /// No description provided for @qrValidMessage.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @scanQrOption.
  ///
  /// In en, this message translates to:
  /// **'Scan QR Code'**
  String get scanQrOption;
}
